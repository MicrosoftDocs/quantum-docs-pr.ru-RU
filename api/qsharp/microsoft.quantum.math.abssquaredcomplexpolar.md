...
---
# <a name="abssquaredcomplexpolar-function"></a>Функция Абсскуаредкомплексполар
...
Возвращает абсолютное значение комплексного числа типа в квадрате `ComplexPolar` .
...
Абсолютное значение в квадрате $ | c | ^ 2 = r ^ 2 $.