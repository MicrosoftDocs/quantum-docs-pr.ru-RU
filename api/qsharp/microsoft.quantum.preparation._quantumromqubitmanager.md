...
---
# <a name="_quantumromqubitmanager-function"></a>Функция _QuantumROMQubitManager
...
## <a name="output--littleendianqubitqubit"></a>Выходные данные: (([литтлиндиан](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[кубит](xref:microsoft.quantum.lang-ref.qubit)[]),[кубит](xref:microsoft.quantum.lang-ref.qubit)[])
