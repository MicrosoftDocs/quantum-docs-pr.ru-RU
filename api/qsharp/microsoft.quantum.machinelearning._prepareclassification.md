...
### <a name="encoder--littleendian--unit-adj--ctl"></a>кодировщик: [литтлиндиан](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [единицы измерения](xref:microsoft.quantum.lang-ref.unit) + CTL
