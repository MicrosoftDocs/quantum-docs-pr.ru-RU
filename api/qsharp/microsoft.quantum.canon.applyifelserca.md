...
### <a name="zeroop--t--unit-adj--ctl"></a>Зеруп: 'T => [модульные](xref:microsoft.quantum.lang-ref.unit) года + CTL
...
### <a name="oneop--u--unit-adj--ctl"></a>Онеоп: "U => [единицы](xref:microsoft.quantum.lang-ref.unit) + CTL
