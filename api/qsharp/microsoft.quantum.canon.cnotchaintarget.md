...
---
# <a name="cnotchaintarget-operation"></a>Операция Кнотчаинтаржет
...
> [!WARNING]
> Кнотчаинтаржет является устаревшим. Взамен рекомендуется использовать <xref:Microsoft.Quantum.Canon.ApplyCNOTChainWithTarget>.
