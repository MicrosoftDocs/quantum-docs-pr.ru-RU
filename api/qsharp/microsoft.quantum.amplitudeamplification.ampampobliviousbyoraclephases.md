...
---
# <a name="ampampobliviousbyoraclephases-function"></a>Функция Ампампобливиаусбйораклефасес
...
> [!WARNING]
> Ампампобливиаусбйораклефасес является устаревшим. Взамен рекомендуется использовать <xref:Microsoft.Quantum.AmplitudeAmplification.ObliviousAmplitudeAmplificationFromStatePreparation>.
>
> Используйте @"microsoft.quantum.amplitudeamplification.obliviousamplitudeamplificationfromstatepreparation".
