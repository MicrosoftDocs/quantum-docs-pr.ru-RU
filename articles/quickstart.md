...
* Установите пакет средств разработки Quantum для [Python](xref:microsoft.quantum.install.python) или [.NET](xref:microsoft.quantum.install.cs).
...
В этом руководстве используются основные программы и описывается следующее:

1. Ряд квантовых алгоритмов, реализованных на квантовом языке программирования Q#.
1. Основная программа, реализованная на любом традиционном языке программирования, например Python или C#, которая используется в качестве основной точки входа для вызова операций Q# и применения квантовых алгоритмов.
