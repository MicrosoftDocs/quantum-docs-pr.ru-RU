...
Эта команда импортирует строки 4 – 8 из [файла`Game.qs` из примера `chsh-game`](https://github.com/microsoft/Quantum/blob/master/samples/algorithms/chsh-game/Game.qs), помечая их как код Q # для выделения синтаксиса.
