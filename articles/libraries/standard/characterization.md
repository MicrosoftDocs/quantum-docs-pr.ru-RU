...
Вспомогательная кубит, используемая в качестве элемента управления для `U(m)`, затем измеряется в $X $ для получения одного классического `Result`.
