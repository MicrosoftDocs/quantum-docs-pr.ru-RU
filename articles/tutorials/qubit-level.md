...
В рамках Q# операции операторы, вызывающие вызываемые, будут выполняться в последовательном порядке.
...
Хотя Q# программа является повсеместной во всех средах, используемых для ее вызова, способ ее выполнения будет зависеть. Таким образом, просто следуйте инструкциям на вкладке, соответствующей вашей программе установки: работа из Q# приложения командной строки или использование основной программы в Python или C#.
