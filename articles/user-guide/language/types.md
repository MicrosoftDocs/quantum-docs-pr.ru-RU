...
Тип литерала массива определяется общим базовым типом всех элементов массива. Следовательно, попытка создать массив с элементами, не имеющими общего базового типа, вызовет ошибку.  
