...
---
# <a name="types-in-no-locq"></a>Типы вQ#
...
Помимо анонимных элементов, определяемые пользователем типы также поддерживают *именованные элементы* Q# версии 0,7 или более поздней. Например, можно присвоить элементам имя `Re` Double, представляющей реальную часть комплексного числа и `Im` для мнимой части: 
...
Хотя оба типа `Complex` и `Polar` оба имеют базовый тип `(Double, Double)` , эти два типа полностью несовместимы в, что Q# минимизирует риск случайного вызова сложной математической функции с полярными координатами и наоборот.
