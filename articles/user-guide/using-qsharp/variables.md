...
Можно присвоить значение любого типа в Q # переменной для повторного использования в операции или функции с помощью `let` ключевого слова. 
...
В случае массивов [`Microsoft.Quantum.Arrays`](xref:microsoft.quantum.arrays) в стандартной библиотеке Q # предусмотрены необходимые средства для многих общих задач инициализации и манипуляции массивов, что позволяет избежать необходимости обновлять элементы массива в первую очередь. 
