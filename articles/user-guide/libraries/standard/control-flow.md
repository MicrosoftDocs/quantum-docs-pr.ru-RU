...
Но в терминах <xref:Microsoft.Quantum.Canon.ApplyToEachCA> функций и операций с массивами <xref:Microsoft.Quantum.Arrays.Zipped> , таких как, это гораздо короче и проще в чтении:
...
### <a name="time-ordered-composition"></a>Композиция Time-Ordered ###
