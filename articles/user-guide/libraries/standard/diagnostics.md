...
Поскольку `AssertMeasurement` функция является функцией с пустым кортежем в качестве типа выходных данных, `AssertMeasurement` в программе Q # не вызываются никакие эффекты.
