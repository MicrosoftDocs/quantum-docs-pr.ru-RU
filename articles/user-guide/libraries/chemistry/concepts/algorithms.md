...
Пример, включающий моделирование модели Хуббард, можно найти в виде [ Q# образца](https://github.com/microsoft/Quantum/tree/master/samples/simulation/hubbard).
