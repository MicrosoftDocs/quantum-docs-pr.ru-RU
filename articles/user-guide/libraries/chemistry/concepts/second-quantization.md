...
## <a name="second-quantized-fermionic-hamiltonian"></a>Second-Quantized Фермионик Хамилтониан
...
\бегин{екуатион} \Хат{х} = \сум \_ {PQ} h \_ {PQ} a ^ \дагжер \_ p a \_ q + \фрак {1} {2} \сум \_ {пкрс} H \_ {пкрс} a ^ \дагжер \_ p a ^ \дагжер \_ . \текстрм \_ \_ NUC s + H \_ {\лабел{ЕК totalHam}, \end{Equation}:}, где $h \_ {\textrm NUC} $ — это постоянная Born-Oppenheimer аппроксимация) и
