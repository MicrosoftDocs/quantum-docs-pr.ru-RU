...
Следуйте этим инструкциям по обновлению проектов Q#, независимо от того, на каком языке написана основная программа для выполнения операций Q#: C# или Python.
...
1. Обновите расширение Q# для Visual Studio.
